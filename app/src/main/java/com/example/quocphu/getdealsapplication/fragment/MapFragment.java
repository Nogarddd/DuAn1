...
import com.example.quocphu.getdealsapplication.StoreUserActivity;
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void xuLyQuyen() {
        ...
        final LocationManager service = (LocationManager)getContext().getSystemService(LOCATION_SERVICE);
                ...
                node_store.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for(DataSnapshot itemStore : dataSnapshot.getChildren()){
                            ...
                            //tv_location.setText(store.getLocation());
                            //Picasso.with(getContext()).load(store.getPhotoUrl()).into(iv_store);
