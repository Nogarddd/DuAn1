...
public class StoreUserActivity extends AppCompatActivity {
    CardView store_user,info_user;
    private TextView tv_nameStore,tv_post,tv_phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store_user = findViewById(R.id.strore_user_store);
        info_user = findViewById(R.id.info_user_store);
        tv_nameStore = findViewById(R.id.tv_name_store);
        tv_phone = findViewById(R.id.tv_phone_store);
        tv_post = findViewById(R.id.tv_post_store);
        ...
        if(key_user != null) {
            Toast.makeText(this, "Key User", Toast.LENGTH_SHORT).show();
            ...
            store_user.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(StoreUserActivity.this, StoreDetailActivity.class);
